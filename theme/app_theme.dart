...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    secondaryHeaderColor: const Color(0xFF27ae61),
    popupMenuTheme: PopupMenuThemeData(
      color: const Color(0xffffffff),
      textStyle: lightTextTheme.displayMedium?.merge(const TextStyle(color: Color(0xff495057))),
    ),
    bottomAppBarTheme: const BottomAppBarTheme(color: Color(0xffffffff), elevation: 2),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    inputDecorationTheme: const InputDecorationTheme(
      ...
      border: OutlineInputBorder(
          borderRadius: BorderRadius.all(Radius.circular(4)), borderSide: BorderSide(width: 1, color: Colors.white70)),
    ),
    dividerColor: const Color(0xffd1d1d1),
    ...
    popupMenuTheme: PopupMenuThemeData(
      ...
      textStyle: lightTextTheme.bodyMedium?.merge(const TextStyle(color: Color(0xffffffff))),
    ),
