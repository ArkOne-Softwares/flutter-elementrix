...
class FESearchInput extends StatelessWidget {
  ...
  const FESearchInput({required this.searchController, required this.hintText, super.key});
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.search, size: UiConfig.iconSize, color: UiConfig.accentColor),
          filled: true,
          fillColor: Colors.transparent,
          border: InputBorder.none,
          hintText: hintText,
          hintTextDirection: TextDirection.ltr,
          hintStyle: TextStyle(color: UiConfig.accentColor.withOpacity(.75), fontSize: UiConfig.fontSize),
